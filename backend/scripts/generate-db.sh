...
# NODE_ENV = .env_prod | .env_dev file path
# SCRIPT_DIR = generate-db file path
# BACKEND_DIR = backend/ folder path
# pwd = root project folder path
...
# clean all files related to sequelize
# like config.*, models, migrations, seeders, sequelizerc
...
# install seq cli and db packages
echo "Installing packages..."
npm install sequelize pg pg-hstore dotenv
npm install -D sequelize-cli

# init seq-cli to create config.json models migrations
